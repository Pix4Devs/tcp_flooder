...
pub mod packet {
    ...
    pub fn build_random_packet(partial_packet: &pTCPpData, tmp_packet: &mut [u8]) {
    ...
    pub fn send_tcp_packets(destination_ip: Ipv4Addr, interface: String, count: u32) {
        ...
        for interface in interfaces.iter() {
            ...
            println!("Interface name: \x1b[35m{:?}\x1b[0m\nInterface IP: \x1b[35m{:?}\x1b[0m\n", &interface.name, iface_ip)
        }
        ...
        let partial_packet: pTCPpData = pTCPpData {
        ...
        for i in 0..count {
            ...
            if &i % 10000 == 0 {
                println!("{}",format!("[+] Sent {:?} packets", &i).green());
            }
